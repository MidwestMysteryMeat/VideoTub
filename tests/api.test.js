...
process.env.FFPROBE_DISABLED = "1"; // fixture is a fake MP4 header; a real ffprobe would (correctly) reject it
process.env.TRUST_PROXY = "1"; // tests simulate distinct clients via X-Forwarded-For
